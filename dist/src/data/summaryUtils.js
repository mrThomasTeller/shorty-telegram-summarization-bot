...
export function getPartsAndPointsCountForText(fullText) {
...
const getPointsCountForOnePart = (text) => Math.min(Math.ceil(text.length / symbolsForOnePoint), maxPointsCount);
export const formatSummaryFromGpt = (summary) => summary.replace(/\.$/, '');
