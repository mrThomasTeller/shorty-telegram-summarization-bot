...
export function createGptChatMessage(text) {
    return {
        role: 'assistant',
 ...
 */
export const gptTestSummary = (page, pointsOnPage, offsetPointsPage = page) => {
    const pointsRange = _.range(offsetPointsPage * pointsOnPage + 1, (offsetPointsPage + 1) * pointsOnPage + 1);
